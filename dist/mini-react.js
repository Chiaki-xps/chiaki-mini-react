...
(function () {
  ...
  function reconcileChildren(wipFiber, elements) {
    ...
    let oldFiber =
      (_a = wipFiber.alternate) === null || _a === void 0 ? void 0 : _a.child;
    ...
    while (index < elements.length || oldFiber != null) {
      ...
      const sameType =
        ...
        (oldFiber === null || oldFiber === void 0 ? void 0 : oldFiber.type);
  ...
  function useState(initialState) {
    ...
    const oldHook =
      (_a = wipFiber.alternate) === null || _a === void 0
        ? void 0
        : _a.stateHooks[stateHookIndex];
    const stateHook = {
      // 当前state的值
    ...
    function setState(action) {
      ...
      wipRoot = Object.assign(Object.assign({}, currentFiber), {
  ...
  function commitEffectHooks() {
    function runCleanup(fiber) {
      ...
      if (!fiber) return;
      (_b =
        (_a = fiber.alternate) === null || _a === void 0
          ? void 0
          : _a.effectHooks) === null || _b === void 0
        ? void 0
        : _b.forEach((hook, index) => {
            var _a;
            const deps = fiber.effectHooks[index].deps;
            if (!hook.deps || !isDepsEqual(hook.deps, deps)) {
              (_a = hook.cleanup) === null || _a === void 0
                ? void 0
                : _a.call(hook);
            }
          });
    ...
    function run(fiber) {
      var _a;
      if (!fiber) return;
      (_a = fiber.effectHooks) === null || _a === void 0
        ? void 0
        : _a.forEach((newHook, index) => {
            var _a;
            if (!fiber.alternate) {
